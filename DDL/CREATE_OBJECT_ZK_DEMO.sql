...
/
 CREATE SEQUENCE   "T_IN_OUT_ZK_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100000 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
 CREATE SEQUENCE   "T_NOT_ENTRY_ZK_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100000 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
...
/
 CREATE SEQUENCE   "T_PRODUCTS_ZK_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100000 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL
/
...
/
--その他
--過去＆デモデータ削除JOBの作成＆有効化を実行
begin
 PKG_ZK_DELETE_OLD_DATA.fnc_JobCreate;
 PKG_ZK_DELETE_OLD_DATA.fnc_JobEnabled;
 PKG_ZK_RESET_DEMO_DATA.fnc_JobCreate;
 PKG_ZK_RESET_DEMO_DATA.fnc_JobEnabled;
end;
/
